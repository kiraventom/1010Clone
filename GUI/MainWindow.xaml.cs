...
namespace GUI
{
	public partial class MainWindow : Window
	{
		...
		private void Restart()
		{
			...
			ShowcaseClickOffset = new Vector();
			Lost = false;
		...
		private void MainWindow_Closed(object sender, EventArgs e)
		{
			if (!Lost)
			{
				...
				Properties.Settings.Default.SavedShowcase0 = figure0 != null ? (int)figure0.Shape : -1;
				Properties.Settings.Default.SavedShowcase1 = figure1 != null ? (int)figure1.Shape : -1;
				Properties.Settings.Default.SavedShowcase2 = figure2 != null ? (int)figure2.Shape : -1;
		...
		private bool DidLose()
		{
			for (int i = 0; i < Showcase.Maps.Length; ++i)
			{
				...
				if (figure != null && GameMap.CanFit(figure))
					return false;
			}
